...
from Ankit.MusicUtilities.helpers.decorate import authorized_users_only
from Ankit import dbb, app, BOT_USERNAME, BOT_ID, ASSID, ASSNAME, ASSUSERNAME, ASSMENTION
from Ankit.MusicUtilities.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, ASS_ACC)
from Ankit.MusicUtilities.database.queue import (get_active_chats, is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
from Ankit.MusicUtilities.database.onoff import (is_on_off, add_on, add_off)
from Ankit.MusicUtilities.database.chats import (get_served_chats, is_served_chat, add_served_chat, get_served_chats)
from Ankit.MusicUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup, audio_markup, play_list_keyboard)
...
from Ankit.config import DURATION_LIMIT
...
from Ankit.MusicUtilities.helpers.logger import LOG_CHAT
...
from Ankit.MusicUtilities.helpers.inline import (play_keyboard, search_markup2, search_markup)
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        link = "https://github.com/LEGEND-ANKIT"
