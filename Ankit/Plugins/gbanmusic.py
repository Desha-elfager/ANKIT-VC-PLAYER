from Ankit import app, SUDOERS, BOT_ID, OWNER
from Ankit.MusicUtilities.database.gbanned import (get_gbans_count, is_gbanned_user, add_gban_user, add_gban_user, remove_gban_user)
from Ankit.MusicUtilities.database.sudo import (get_sudoers, add_sudo, remove_sudo)
        ...
        if user.id == from_user.id:
            ...
            for sex in served_chats:
                try:
                    ...
                    pass    
            ban_text = f"""
__**New Global Ban List On Ankit Music**__\n
...
async def chat_watcher_func(_, message):
    ...
    if await is_gbanned_user(userid):
        try:
            ...
            return       
        await message.reply_text(f"{checking} is globally banned by Ankit Music and has been kicked out of the chat.\n\n**Possible Reason:** Potential Spammer and Abuser.")
